...
return [
    ...
    'Log' => [
        ...
        'shell' => [
            ...
            'path' => LOGS,
            'file' => 'shell_log',
            'levels' => ['warning', 'error', 'critical', 'alert', 'emergency','debug'],
        ],
    ],
     ...
     */
     ...
     'ActivePlugins' => [
        'Registration', 'Aziende', 'Remarks', 'AttachmentManager', 'Gdpr', 'Reports', 'Surveys' /*'Calendar' ,'Document','Scadenzario','Crm',
