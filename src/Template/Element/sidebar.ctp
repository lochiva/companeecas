...
$menu = [
  [
    ...
    'controller' => ['Home'],
    'action' => [],
    'levels' => ['admin', 'area_iv', 'ragioneria', 'ragioneria_adm', 'questura', 'ente_ospiti', 'ente_contabile'],
    'url' => Router::url('/'),
    'target' => '',
  ...
  [
    ...
    'controller' => ['Home'],
    'action' => ['index'],
    'levels' => ['admin', 'area_iv', 'ragioneria', 'ragioneria_adm', 'questura'],
  ...
  [
    ...
    'action' => ['index'],
    'levels' => ['admin', 'area_iv', 'ragioneria', 'ragioneria_adm', 'ente_contabile'],
