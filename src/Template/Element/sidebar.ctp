<?php
/** 
* Companee :  sidebar   (https://www.companee.it)
...
$menu = [
  [
    ...
    'controller' => ['Home'],
    'action' => [],
    'levels' => ['admin', 'area_iv', 'ro_area_iv', 'ragioneria', 'questura', 'ente_ospiti', 'ente_contabile'],
    'url' => Router::url('/'),
    'target' => '',
  ...
  [
    ...
    'controller' => ['Home'],
    'action' => ['index'],
    'levels' => ['admin', 'area_iv', 'ro_area_iv', 'ragioneria', 'questura'],
  ...
  [
    ...
    'controller' => ['Reports'],
    'action' => ['index'],
    'levels' => ['admin', 'area_iv', 'ro_area_iv','ente_ospiti'],
  ...
  [
    ...
    'action' => ['index'],
    'levels' => ['admin', 'area_iv','ro_area_iv', 'ragioneria', 'ente_contabile'],
