...
class Installer
{
    ...
    public static function postInstall(Event $event)
    {
        ...
        $rootDir = dirname(dirname(__DIR__));
         ...
         $io->write('Creating app.php if not exists...' );
   ...
   /**
     * Create the config/localconfig.php file if it does not exist.
     *
     * @param string $dir The application's root directory.
     * @param \Composer\IO\IOInterface $io IO interface to write to console.
     * @return void
    ...
    {
        $appConfig = $dir . '/config/localconfig.php';
        $defaultConfig = $dir . '/config/localconfig.default.php';
        if (!file_exists($appConfig)) {
            copy($defaultConfig, $appConfig);
    ...
    public static function setFolderPermissions($dir, $io)
    {
        ...
        $changePerms($dir . '/PDF', $worldWritable, $io);
        $changePerms($dir . '/FILES', $worldWritable, $io);
