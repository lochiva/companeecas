...
*
* Companee :    Gestione  (https://www.companee.it)
  ...
  $("#table-report").trigger("update");
    ...
    function setTable(){
        ...
        $("#table-report").tablesorter({
              ...
              headers: {0:{filter: false}, 5: { filter: false},6: { filter: false },9:{filter: false,sorter: false} }
          }).tablesorterPager({
                ...
                container: $(".pager"),
                ajaxUrl : pathServer + 'crediti/Ws/getCreditsTotals/?{filterList:filter}&{sortList:column}&size={size}&page={page}&startDate='+startDate+'&endDate='+endDate+' ',
        ...
        $('.tablesorter-filter[data-column="9"]').css('display','none');
    }
    ...
    $(document).ready(function(){
      ...
      $('#xls_export').click(function(){
          window.open(pathServer + 'crediti/report/gestione/1','_self');
      });
...
<section class="content-header">
    <h1>
        Crediti
        <small>Report Crediti</small>
    </h1>
    <ol class="breadcrumb">
        <li><a><i class="fa fa-bank"></i>Crediti</a></li>
        <li class="active">Gestione</li>
    </ol>
</section>
