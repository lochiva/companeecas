...
<section class="content-header">
    <h1>
        ...
        <small>Gestione <?=__c('clienti')?></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?=Router::url('/');?>"><i class="fa fa-home"></i> Home</a></li>
        <li><a href="<?=Router::url('/ficgtw/home');?>"><?=__c('Fatture in Cloud')?></a></li>
        <li class="active">Gestione <?=__c('Clienti')?></li>
    </ol>
</section>
        ...
        <div class="col-xs-12">
            <div id="box-aziende" class="box box-info">
                <div class="box-header with-border">
                  ...
                  <h3 class="box-title"><?=__c('Aggiunta clienti')?></h3>
...
<?php echo $this->Element('Ficgtw.modale_nuovo_cliente'); ?>
