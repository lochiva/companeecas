...
ts.themes = {
	'bootstrap' : {
		...
		// i seguenti commentati sono stati editati per rendere visibile sempre le icone di ordinamento.
		//iconSortNone : 'bootstrap-icon-unsorted', // class name added to icon when column is not sorted
		//iconSortAsc  : 'icon-chevron-up glyphicon glyphicon-chevron-up', // class name added to icon when column has ascending sort
		//iconSortDesc : 'icon-chevron-down glyphicon glyphicon-chevron-down', // class name added to icon when column has descending sort
		iconSortNone : 'fa fa-sort pull-right text-light-blue', // class name added to icon when column is not sorted
		iconSortAsc  : 'fa fa-sort-asc pull-right text-light-blue', // class name added to icon when column has ascending sort
		iconSortDesc : 'fa fa-sort-desc pull-right text-light-blue', // class name added to icon when column has descending sort
