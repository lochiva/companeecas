...
$(document).on('click','.edit',function(e){
    ...
    $('#myModalOrder #reference_for_remarks').html('ordini');
    $('#myModalOrder #reference_id_for_remarks').html(idSede);
    $('#myModalOffer #label_notification_remarks').html('Ordine numero '+idSede);
    
    //mostro badge remarks e conto numero note
    remarksNumberForBadge('ordini', idSede);
...
//#########################################################################################################################
//Apertura modale nuovo ordine
$(document).on('click', '#new-order', function(){
	$('#myModalOrder #reference_for_remarks').html('');
  $('#myModalOrder #reference_id_for_remarks').html('');
  $('#myModalOrder #label_notification_remarks').html('');
	$('#div-remarks').hide();
});

//#######################################################################################################################
//Alla chiusura della modale ordine
$(document).on('hidden.bs.modal', '#myModalOrder', function () {    
	        ...
	        if(data.response == "OK"){ 
              ...
              $('#idAzienda').val(data.data.id_azienda).trigger('change');
			      ...
			      $('[name="id"]').val(idOrder);
                        ...
                        $('#label_notification').html('Ordine '+data.data.name);
...
function clearModale(){
	...
	$('[name="id"]').val("");
	$('[name="id_azienda"]').val('').trigger('change');
  $('[name="nome"]').val('');
  $('[name="note"]').val('');
