...
class StatementCompanyComponent extends Component
{
    ...
    public function getStatements($pass = []) {
        ...
        $opt['fields'] = ['StatementCompany.id', 'StatementCompany.approved_date', 'AgreementsCompanies.name', 'Agreements.cig', 'Statements.period_label', 'Statements.year', 'Status.name', 'Status.id', 'Statements.period_id', 'Statements.id', 'StatementCompany.uploaded_path', 'StatementCompany.id'];
