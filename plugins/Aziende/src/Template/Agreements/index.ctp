        ...
        <div class="col-xs-12">
            <div id="box-guests" class="box box-guests">
                <div class="box-header with-border">
                  ...
                  <a id="newAgreement" class="btn btn-info btn-xs pull-right" data-toggle="modal" data-target="#modalAgreement" data-backdrop="static" data-keyboard="false" style="margin-left:10px"><i class="fa fa-plus"></i> Nuovo</a>
