    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Nuova Sede</h4>
            </div>
                ...
                <form class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" placeholder="Comune" name="comune" id="inputComune" class="form-control required">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" placeholder="Provincia" name="provincia" id="inputProvincia" class="form-control required">
                            </div>
                        </div>
