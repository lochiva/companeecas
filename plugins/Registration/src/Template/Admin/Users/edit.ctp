...
<div class="edit-user">
    ...
    <fieldset>
        ...
        <?php echo $this->Form->input('role', ['options' => ['admin' => 'Admin' , 'area_iv' => 'Area IV', 'ragioneria' => 'Ragioneria','ragioneria_adm' => 'Ragioneria_adm', 'questura'=>'Questura', 'ente_ospiti' => 'Ente ospiti', 'ente_contabile' => 'Ente contabile']]); ?>
