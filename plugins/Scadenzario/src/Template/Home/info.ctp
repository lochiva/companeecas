        ...
        <div class="col-md-8">
            <div class="box box-info">
                ...
                <div class="box-footer clearfix">
                    ...
                    <!--<a class="btn btn-sm btn-info btn-flat pull-left" href="javascript::;">Place New Order</a>-->
                    <a class="btn btn-sm btn-default btn-flat pull-right" href="<?=Router::url('/aziende/sedi/index/' . $idAzienda)?>">Gestione sedi</a>
        ...
        <div class="col-md-4">
            <div class="box box-primary">
                ...
                <div class="box-footer text-center">
                    ...
                    <a class="btn btn-sm btn-default btn-flat pull-right" href="<?=Router::url('/aziende/contatti/index/azienda/' . $idAzienda)?>">Gestione contatti</a>
                </div><!-- /.box-footer -->
              </div>
        </div>
    </div>
